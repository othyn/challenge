...
Overall I think the project went well. There are certainly areas of improvement, mainly being more stict with myself in terms of time management when there aren't external factors at play. I am happy with the application design and quality of code developed, following modern design principals along a logical path to help assist with a maintainable project for future developments. I decided against using a css framework in the end, this as its usage was too much overhead for very little usage. Instead, whipping together custom css for elements style directly as it was more appropriate. Accessibility on the form elements would have also helped bring the application to the next level, in regard to screen reader access, although the basic nature should allow such technology to function correctly without prompt, it's always better to be explicit.
...
- A more strict personal time plan. Something in which I plan for my junior team day-in-day-out, and utlise my work calendar for my personal time, is time planning. Mapping it to this task should have been habitual at this point, but my mindset tripped me up on my todo list. Not my usual way, but a mistake nontheless. Taking the time to plan time taking more accurately is a necessity, as was this planning document. Just a small time analysis breakdown against each point to gauge implementation time would have helped hold myself accountable to.. myself, for the benefit of not getting excitable.
