...
- For production systems, generating SSL certs through LetsEncrypt, installing a LAMP stack, hardening the box, setting up firewalls, load balancing, caching, etc. can then all be setup through a service of choice. AWS, DigitalOcean, CloudFlare, etc.
